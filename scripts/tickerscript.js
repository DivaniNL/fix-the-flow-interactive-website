...
const readingState = () => {
    if (!ticking) {
        ...
        window.requestAnimationFrame(() => {
            ...
            console.log("ik check dingetjes" + count + "ScrollY:" + window.scrollY);
            count++;
            ticking = false;
        })
      }
      
      console.log("ik check dingetjes snel" + countfast + "ScrollY:" + window.scrollY);
      countfast++;
}
document.addEventListener('scroll', readingState);
